...
object MvStats
{
	val BHOP_ONE_CM = ResourceLocation.fromNamespaceAndPath(MvMod.ID, "bhop_one_cm")
	val SHARK_ONE_CM = ResourceLocation.fromNamespaceAndPath(MvMod.ID, "shark_one_cm")
	val TRIMPS = ResourceLocation.fromNamespaceAndPath(MvMod.ID, "trimps")
